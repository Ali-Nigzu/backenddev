...
import numpy as np
import torch
# prepare_classification_images is intentionally not imported; preprocessing is handled by demographics.preprocessing.
from .create_timm_model import create_model
# Detector structures are intentionally not vendored for backend-only inference.
